...
6. Статус проверьте в e-Devlet (см. в конце).
...
После этого статус в Göçbil должен стать `Onaylandı`. Затем проверьте e-Devlet (см. в конце).
...
Статус в e-Devlet может появиться не сразу (см. в конце).
...
После — проверьте статус в e-Devlet (см. в конце).
